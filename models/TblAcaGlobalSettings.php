...
class TblAcaGlobalSettings extends \yii\db\ActiveRecord
{
    ...
    public static function Findemailsettings()
    {
    	return static::find()->where(['<>','setting_id',''])->One();
    	 
    }
    public static function settinguniquedetails($id)
    {
    	return static::findOne(['setting_id' => $id]);
