...
class TblAcaCodeMaster extends \yii\db\ActiveRecord
{
    ...
    public function getTblAcaLookupOptions()
    {
	 ...
	 public static function codemasteruniquedetails($id)
    {
    	return static::findOne(['code_id' => $id]);
    
    }
	public static function codemasterfindcode($value)
    {
    	$model = static::find()->where(['lookup_code' => $value])->one();
