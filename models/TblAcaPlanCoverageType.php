...
class TblAcaPlanCoverageType extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_id', 'period_id', 'plan_class_number', 'plan_offer_type', 'plan_type_doh', 'employee_medical_plan', 'created_by'], 'required'],
            ...
            [['plan_class_name'], 'string', 'max' => 200],
    ...
    public function planclasses($cmp_id)
    {
    	...
    	$sql="SELECT plan_class_name,CONCAT(plan_class_id ,'') as plan_class_id FROM tbl_aca_plan_coverage_type WHERE company_id='".$cmp_id."' ";
