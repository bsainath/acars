...
class TblAcaPlanCoverageTypeOffered extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['plan_class_id', 'employee_mv_coverage',  'employee_essential_coverage','spouse_essential_coverage', 'spouse_conditional_coverage', 'dependent_essential_coverage', 'created_by'], 'required'],
