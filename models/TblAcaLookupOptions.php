...
class TblAcaLookupOptions extends \yii\db\ActiveRecord
{
    ...
    public function getCode()
    {
	 ...
	 public static function lookupoptionsalldetails()
    {
    		return static::find()
   		->joinWith(['code'])
    ...
    public static function editlookupoptionsalldetails($id)
    {
    	return static::find()
    ...
    public static function lookupuniquedetails($id)
    {
    	return static::findOne(['lookup_id' => $id]);
    
    }
    
	 public static function lookupfindsectionid($id)
	    {
	    	$model = static::find()->where(['lookup_id' => $id])->one();
	    	
	    	return $model->section_id;
	    
	    }
		
		 public static function lookupfindoption($value , $code_id)
	    {
	    ...
	    $model = static::find()->where(['lookup_value' => $value])->andwhere(['code_id' => $code_id])->one();
