...
class TblAcaBrands extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            [['brand_name', 'support_email', 'support_number', 'brand_status', 'is_deleted', 'created_by'], 'required'],
    ...
    public function scenarios()
    {
    	...
    	$scenarios['save'] = ['brand_name','brand_logo', 'support_email', 'support_number', 'brand_status', 'is_deleted', 'created_by','required'];
