...
<style>
.varun{
	background-image:-webkit-linear-gradient(#6394ce,#395fa2);
	background-image: linear-gradient( to top, rgb(99, 148, 206), rgb(57, 95, 162));
}
</style>
...
$(function(){
	...
	$( "#collapseOne" ).prev().css( "background-image", "linear-gradient( to top, rgb(99, 148, 206), rgb(57, 95, 162))" );
	$(".custom-bg").css( "color", "" );
            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <div class="panel  box " id="generalplaninformation">
                  <div class="parent-tabs box-header with-border" style="background-image:linear-gradient( to top, rgb(99, 148, 206), rgb(57, 95, 162));">
