...
<div class=" box-info">
     ...
     <?php if($new_client->isNewRecord ? $form = ActiveForm::begin(['enableClientValidation' => false,'options' => ['enctype'=>'multipart/form-data','validateOnSubmit' => true,'class'=>'','id'=>'client-form']]) : $form = ActiveForm::begin(['enableClientValidation' => false,'options' => ['method' => 'post','enctype'=>'multipart/form-data','validateOnSubmit' => true,'class'=>'','id'=>'client-form']])) ?>
             ...
             <?php  
                ...
                <div class="form-group">
                 <div class="col-sm-12">
                  <label class="control-label"><h4>Client Name<span class="imp_red">*</span></h4></label>
                    <?= $form->field($new_client, 'client_name')->label(false)->textInput(['class'=>'form-control form-height','maxlength'=>'34','disabled'=> $new_client->isNewRecord ? false : true]); ?>
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  ...
                  <?= $form->field($new_client, 'order_number')->label(false)->textInput(['class'=>'form-control form-height','maxlength'=>'6','disabled'=> $new_client->isNewRecord ? false : true]); ?>
                   </div>
                </div>
                <div class="form-group">
                   <div class="col-sm-12">
                  <label for="inputEmail3" class="control-label"><h4>Contact Person First Name<span class="imp_red">*</span></h4></label>
                    <?= $form->field($new_client, 'contact_first_name')->label(false)->textInput(['class'=>'form-control form-height','maxlength'=>'34']); ?>
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Contact Person Last Name<span class="imp_red">*</span></h4></label>
                     <?= $form->field($new_client, 'contact_last_name')->label(false)->textInput(['class'=>'form-control form-height','maxlength'=>'34']); ?>
               ...
               <div class="form-group">
                  ...
                  $data = ArrayHelper::map($models, 'user_id', 'first_name');
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Contact Person Phone Number<span class="imp_red">*</span></h4></label>
                  	...
                  	<?= $form->field($new_client,'phone')->label(false)->textInput()->widget(\yii\widgets\MaskedInput::className(), [  'mask' => '(999) 999-9999',
				'clientOptions' => [
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Product</h4></label>
                    ...
                    $listData= ArrayHelper::map(TblAcaLookupOptions::find()->where(['=', 'code_id', 4])->andwhere(['<>', 'lookup_status', 2])->all(), 'lookup_id', 'lookup_value');
					   echo $form->field($new_client, 'product')->dropDownList($listData, ['prompt'=>'Select','class'=>'form-control form-height','disabled'=> $new_client->isNewRecord ? false : true])->label(false);;
					     ?>
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                  <label for="inputEmail3" class="control-label"><h4>Sub EIN Count  <?php if($new_client->isNewRecord){}else{?> <small>(Current Ein Count :<?php echo $old_ein_count;	 }?>)</small></h4></label>
                   <?= $form->field($new_client, 'ein_count')->label(false)->textInput(['type' => '','min'=>'1','class'=>'form-control form-height numbers','maxlength'=>'3','onkeyup'=>'this.value = minmax(this.value, 1)','disabled'=> $new_client->isNewRecord ? false : ( $new_client->reporting_structure == 15 ? true : false)]); ?>
			 ...
			 <script type="text/javascript">
					document.write('<?= Html::submitButton($new_client->isNewRecord ? 'Save' : 'Update', ['class' => $new_client->isNewRecord ? 'btn btn-success' : 'btn btn-success','id' => 'client_form']) ?>');
			</script>
			<noscript>
