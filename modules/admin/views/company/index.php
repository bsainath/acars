...
<?php $form = ActiveForm::begin([
        ...
        'method' => 'get',
					...
					<div class="col-lg-3  col-xs-4 padding-left-0 display-class"id=" w0-filters">
...
'buttons' => [
    'my_button' => function ($url, $model, $key) {
        ...
        return Html::tag('p', '<a><span class="fa fa-floppy-o"></span></a>', ['class' => 'pointer','onclick'=>'changeStatus('.$model->company_id.')']) ;
    },
]
			],
        ],
