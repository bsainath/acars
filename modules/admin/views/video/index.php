						...
						<div class="box">
                          ...
                          <?php foreach($model as $video){?>
										<tr>
											...
											<td><?php echo $video->screen;?></td>
											<td style="width: 50%;"><input id="link_<?php echo $video->vedio_uid;?>" type="text" class="form-control"  value=<?php if(!empty($video->url)) { echo $video->url;}else{?>''<?php }?>></td>

											<td style="text-align: center;"><a	onclick="Updatevideolink(<?php echo $video->vedio_uid;?>);"><i
