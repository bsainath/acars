				...
				<div class="box-body table-responsive">
					<table id="exampleManagedata" class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<td class="img-width-td"><img class="img-width" src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/Images/profile_image/brand_logo/<?php echo $brands['brand_logo'] ?>"></td>
								<td><?php echo $brands['brand_name'];?></td>
								<td><?php echo $brands['support_email'];?></td>
								<td><?php echo $brands['support_number'];?></td>
