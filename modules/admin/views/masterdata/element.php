	...
	<div class="box-body">
		...
		<div>
			<div class=" table  grid-filter m-5 filter-div-back table-grid">
				...
				<div class="col-lg-4 col-md-6 padding-left-0 element-section" >
		...
		<select id="filter_elements" class="form-control" name="TblAcaLookupOptions[section_id]">
			    <option value="">Select</option>
			     ...
			     ?>
			     <option value="<?php echo $element_id; ?>"><?php echo $element->lookup_value; ?></option>
			     <?php }}?>
	     </select>
								...
								<table id="exampleCompany" class="table table-bordered table-hover">
									...
									<?php foreach($model as $elements){?>
										<tr>
											...
											<td style="text-align: center;"><a	onclick="updateElementlabel(<?php echo $elements->master_id;?>,<?php echo $i;?>);" href="#"><i
